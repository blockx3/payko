...
1. __Easy getting started with Google Sign In.__
...
2. __Send crypto, Receive crypto payment & Crypto wallet all in one app.__
...
3. __Arrange your Payment receiving links together with `Payment Categories`.__
...
4. __Create `Multiple wallets` to receive payments.__
